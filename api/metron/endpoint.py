'''
Endpoint for accessing data stored in elastic search.
This endpoint will be deprecated in next release.
'''

#TODO: go over usages and possible applications of this endpoint in future releases
